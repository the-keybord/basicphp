...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $php_driver_tag = "<?php require __DIR__ . '/../../drivers/down_driver.php'; ?>";
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg">
        ...
        <form method="POST" action="down_builder.php?id=<?php echo htmlspecialchars($question_id); ?>" class="space-y-6">
            <!-- Question Text -->
            <div>
