...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $php_driver_tag = "<?php require __DIR__ . '/../../drivers/radio_driver.php'; ?>";
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg">
        ...
        <form method="POST" action="radio_builder.php?id=<?php echo htmlspecialchars($question_id); ?>" class="space-y-6">
            <!-- Question Text -->
            <div>
                <label for="question" class="block text-sm font-medium text-gray-700 mb-1">Question Text</label>
                <textarea id="question" name="question" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" rows="3"  placeholder="e.g., Which syntax should you use to create the object?"></textarea>
            </div>
            <!-- Optional Code Block -->
            <div>
