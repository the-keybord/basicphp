            ...
            <main class="flex-grow w-full min-w-0">
                ...
                @foreach($renderedQuestions as $index => $q)
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        @else
                            <div class="text-lg font-medium text-gray-800 leading-relaxed" style="font-family:inherit;white-space:pre-wrap;margin:0;padding:0;background:transparent;border:none;overflow:visible;"@if($qModel->question_type === 'drag_and_drop') id="dnd-text-{{ $qModel->id }}" @endif>{!! $parsed['text'] !!}</div>
                        @endif
