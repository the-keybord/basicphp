                                    ...
                                    @foreach($sessions as $session)
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                @else
                                                    <a href="{{ route('admin.sessions.review', $session) }}" class="inline-flex items-center px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 hover:border-blue-300 rounded-lg text-xs font-bold transition shadow-sm">
                                                        <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
