        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl shadow-sm overflow-hidden">
                <div class="p-8 border-b border-gray-50 dark:border-zinc-800/60 bg-gray-50/50 dark:bg-zinc-950/20">
                    <h3 class="text-lg font-black text-gray-900 dark:text-white">Modify Subcategory</h3>
                    <p class="text-sm text-gray-500 dark:text-neutral-450 mt-1">Adjust parent category and fine-tune subcategory test defaults.</p>
                </div>

                <form action="{{ route('admin.subcategories.update', $subcategory) }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input 
                                ...
                                value="{{ old('default_test_size', $subcategory->default_test_size) }}"
                                min="1"
                                max="100"
                                class="block w-full border-gray-200 dark:border-zinc-850 dark:bg-zinc-950/40 rounded-xl p-3.5 text-sm text-gray-700 dark:text-white font-medium focus:ring-blue-500 focus:border-blue-500 transition shadow-sm"
                            >
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input 
                                ...
                                value="{{ old('default_test_time', $subcategory->default_test_time) }}"
                                min="1"
                                max="300"
                                class="block w-full border-gray-200 dark:border-zinc-850 dark:bg-zinc-950/40 rounded-xl p-3.5 text-sm text-gray-700 dark:text-white font-medium focus:ring-blue-500 focus:border-blue-500 transition shadow-sm"
                            >
